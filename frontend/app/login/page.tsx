...
// 1. Criamos um componente interno para o formulário que usa o useSearchParams
function LoginForm() {
...
// 2. Componente principal que envolve tudo com Suspense (Essencial para o Build)
export default function Login() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden font-['Jost',sans-serif] bg-[radial-gradient(circle_at_center,_#ffffff_0%,_#f7f3f9_100%)]">
      ...
      {/* O Suspense aqui resolve o erro do Vercel */}
